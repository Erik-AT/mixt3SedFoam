...
Foam::mixture3ViscosityModels::Batchelor::Batchelor
(
    const word& name,
...
Foam::mixture3ViscosityModels::Batchelor::nu
(
...
) const
{
	return
	(
		nuc*(1.0 + 2.5*alpha_ + 7.6*sqr(alpha_))
	);
}


bool Foam::mixture3ViscosityModels::Batchelor::read
(
    const dictionary& viscosityProperties
)
{
